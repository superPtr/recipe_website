...
//$user_id = $_SESSION['user_id']; // Use session user_id instead of hardcoded value
$user_id =
    ...
    <div class="container">
        ...
        <?php else: ?>
            <form action="submit_recipe.php" method="post" id="joinForm">
                ...
                <div id="recipeDetails" class="recipe-details" style="display: none;">
                    <!-- Recipe details will be loaded here -->
                    <div class="loading">
                        <i class='bx bx-loader-alt'></i> Loading recipe details...
                    </div>
                </div>
